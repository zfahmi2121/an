    ...
    try:
        ...
        if ab =='':
            ...
            try:
                ...
                r = requests.Session()
                dat = {'request_id': '', 'first_name': 'Zul', 'last_name': 'fahmi', 'gender': 'male', 'phone_number': nomor, 'birthday_d': '', 'birthday_m': '', 'birthday_y': '', 'birthday': '1999-03-01', 'username': 'yayakyk22@40gmail.com', 'password': 'Anjaymanar123$$', 'agreeterms': '1'}
                a = 0
                for i in range(int(jumla)):
                    try:
                        a += 1
